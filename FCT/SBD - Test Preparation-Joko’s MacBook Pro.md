...
# Aula Test 1 sbd 2023-24

bytes * tuples / 8 KiB = blocks 
1 
	a) ![[Pasted image 20250506121533.png]] 
	
			It will look something like this
	
	b) select books natural inner join books and copies
	c) Yes
	d) No genreID as the top of booksGenre indexkey
